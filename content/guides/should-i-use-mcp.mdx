...
slug: should-i-use-mcp
order: 3
---

<Lead>
  MCP lets you control other software – that's useful. It's a shared language
  between the software you want to control and the AI Harness you're typing in.
</Lead>
