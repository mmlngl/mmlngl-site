---
name: Run an AI-automated Design Sprint
slug: run-an-ai-automated-design-sprint
skillRefs:
  - 5-whys
  - problem-statement
---
...
<SkillsList filterWith={["5-whys", "problem-statement"]} className="my-8" />
...
<SkillsList filterWith={["5-whys", "problem-statement"]} />
